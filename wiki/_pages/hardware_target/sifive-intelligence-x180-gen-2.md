---
canonical_name: SiFive Intelligence X180 Gen 2
aliases:
- SiFive X180 Gen 2
- X180 Gen 2
subtype: null
tags: []
hardware_targets:
- SiFive Intelligence X180 Gen 2
toolchains: []
constraints:
- 64-bit RISC-V ISA (RV64I)
...
The SiFive Intelligence X180 Gen 2 is a 64-bit RISC-V CPU core from SiFive's 2nd Generation Intelligence family, designed for AIoT and edge computing where higher performance and larger memory addressing are required. It features a dual-issue, in-order 8-stage superscalar pipeline with support for the RISC-V Vector Extension v1.0 (RVV1.0) using 128-bit wide vector registers and a 64-bit datapath. The core supports Int8 and BFloat16 datatypes, integer operations at 2x 32-bit/4x 16-bit/8x 8-bit per cycle, and floating-point operations at 2x single precision and 4x half precision per cycle. It includes interfaces for custom instructions (SCIE), scalar coprocessor (SSCI), and vector coprocessor (VCIX). The core is designed for higher performance and better integration with larger memory systems compared to its 32-bit sibling, with single and multi-core configurations up to quad-cores.
...
- Designed for higher performance and larger memory system integration.

## Optimization-Relevant Details

- ISA/profile: RISC-V RV64I with RVV1.0.
...
- [[sifive-intelligence-x160-gen-2]]: The 32-bit counterpart in the same 2nd Generation Intelligence family.
