...
- **Accelerating LLM Inference on RISC-V Edge Devices via Vector Extension Optimization**: → [rvv-llama-inference-optimization-banana-pi-bpi-f3](optimization_recipe/rvv-llama-inference-optimization-banana-pi-bpi-f3.md)
...
- **BPI-F3 RVV LLM speedup**: → [rvv-llama-inference-optimization-banana-pi-bpi-f3](optimization_recipe/rvv-llama-inference-optimization-banana-pi-bpi-f3.md)
...
- **K3 IME2 optimization**: → [spacemit-ime2-llama-cpp-optimization](optimization_recipe/spacemit-ime2-llama-cpp-optimization.md)
...
- **MLIR-xDSL GEMM Pipeline**: → [mlir-xdsl-rvv-codegen-pipeline](optimization_recipe/mlir-xdsl-rvv-codegen-pipeline.md)
...
- **RVV LLM Inference Optimization on BananaPi BPI-F3**: → [rvv-llama-inference-optimization-banana-pi-bpi-f3](optimization_recipe/rvv-llama-inference-optimization-banana-pi-bpi-f3.md)
...
- **RVV llama.cpp optimization BPI-F3**: → [rvv-llama-inference-optimization-banana-pi-bpi-f3](optimization_recipe/rvv-llama-inference-optimization-banana-pi-bpi-f3.md)
...
- **SiFive X160 Gen 2**: → [sifive-intelligence-2nd-gen](entity/sifive-intelligence-2nd-gen.md)
- **SiFive X180 Gen 2**: → [sifive-intelligence-2nd-gen](entity/sifive-intelligence-2nd-gen.md)
- **SiFive X280 Gen 2**: → [sifive-intelligence-2nd-gen](entity/sifive-intelligence-2nd-gen.md)
...
- **Sophgo SG2380**: → [sophon-sg2380-hardware-target](hardware_target/sophon-sg2380-hardware-target.md)
- **Sophgo SG2380 SoC**: → [sophon-sg2380-hardware-target](hardware_target/sophon-sg2380-hardware-target.md)
- **Sophon SG2042**: → [sophon-sg2042](hardware_target/sophon-sg2042.md)
...
- **SpacemiT K3 LLM benchmark**: → [spacemit-k3-hardware-target](hardware_target/spacemit-k3-hardware-target.md)
...
- **Ventana V2**: → [ventana-veyron-v2-hardware-target](hardware_target/ventana-veyron-v2-hardware-target.md)
- **Ventana Veyron V2**: → [ventana-veyron-v2-hardware-target](hardware_target/ventana-veyron-v2-hardware-target.md)
- **Veyron V2**: → [ventana-veyron-v2-hardware-target](hardware_target/ventana-veyron-v2-hardware-target.md)
- **Veyron V2 chiplet**: → [ventana-veyron-v2-hardware-target](hardware_target/ventana-veyron-v2-hardware-target.md)
...
- **Xuantie C908**: → [xuantie-c908](hardware_target/xuantie-c908.md)
- **Xuantie GNU Toolchain**: → [xuantie-gnu-toolchain](entity/xuantie-gnu-toolchain.md)
- **Xuantie GNU cross-compiler**: → [xuantie-gnu-toolchain](entity/xuantie-gnu-toolchain.md)
...
- **spacemit-x60**: → [spacemit-x60-hardware-target](hardware_target/spacemit-x60-hardware-target.md)
- **spacemit-x60 gcc tuning**: → [spacemit-x60-gcc-tuning](optimization_recipe/spacemit-x60-gcc-tuning.md)
- **spine_barrier_t llama.cpp**: → [spacemit-ime2-llama-cpp-optimization](optimization_recipe/spacemit-ime2-llama-cpp-optimization.md)
...
- **llama.cpp-on-spacemit-k3-benchmark**: mentioned in [spacemit-ime2-llama-cpp-optimization](optimization_recipe/spacemit-ime2-llama-cpp-optimization.md) — *no dedicated page*
...
- [chiplet-based-risc-v-soc](hardware_target/chiplet-based-risc-v-soc.md)
...
- [sophon-sg2380-hardware-target](hardware_target/sophon-sg2380-hardware-target.md)
...
- [ventana-veyron-v2-hardware-target](hardware_target/ventana-veyron-v2-hardware-target.md)
...
*Kernel/workload shapes, datatypes, and baseline implementations.*

*(no pages under this hub yet)*
...
- [rvv-llama-inference-optimization-banana-pi-bpi-f3](optimization_recipe/rvv-llama-inference-optimization-banana-pi-bpi-f3.md)
